...
import logoImage1 from "../../public/images/Sakshi Creation Logo (1).png"; // Second logo (adjust path as needed)
...
const InvoicePDFGenerator: React.FC<InvoicePDFGeneratorProps> = ({
  ...
  const generateInvoice = async () => {
    ...
    // doc.setFont("helvetica", "normal");
    // doc.text(
    //   ` Total Invoice Value (in Words ): INR ${formatAmountInWords(
    //     totalAmount
    //   )}`,
    //   20,
    //   finalY + 10
    ...
    // Footer
    // doc.setFontSize(8);
    // doc.text(`Generated by ${formData.companyName || "N/A"}`, 105, 280, {
    //   align: "center",
    // });
