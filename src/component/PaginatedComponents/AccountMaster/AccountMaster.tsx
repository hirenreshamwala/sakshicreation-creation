...
const AccountMasterPage: React.FC = memo(({ companyList }: { companyList: Company[] }) => {
    ...
    const defaultAccountMasterFilter = {
        ...
        pageSize: 10,
        searchQuery: "",
        filters: { company: [StaticCompanyOptions[companyTab]]
            // , status: ["APPROVED"] 
        },
        includeCounts: true,
        isPagination: true,
    ...
    useEffect(() => {
        ...
        // Apply update only when something exists
    ...
    console.log(filteredAccountMasters,'filteredAccountMastersfilteredAccountMasters')
