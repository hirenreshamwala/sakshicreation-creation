...
const PrinterOrdersList: React.FC = () => {
  ...
  // Filter orders for printer
  const filteredOrders = orders.filter((order: Order) => 
    order.printer?._id === user?.id
  );
  ...
  // Define columns for printer view
  const columns = [
    { id: "orderNo", label: "Order Number" },
    { id: "companyName", label: "Company" },
    { id: "partyName", label: "Party" },
    { id: "paperSize", label: "Size" },
    { id: "paperGsm", label: "Paper GSM" },
    { id: "paperQty", label: "Printer Quantity" },
    { id: "paperQuality", label: "Paper Quality" },
        ...
        renderRow={(row: Order) => {
          return (
            <>
              ...
              <TableCell>{row.printerPaperSize || 'N/A'}</TableCell>
              <TableCell>{row.paperGsm || 'N/A'}</TableCell>
              <TableCell>{row.printerPaperQty || 'N/A'}</TableCell>
              <TableCell>{row.paperQuality || 'N/A'}</TableCell>
...
export default PrinterOrdersList;