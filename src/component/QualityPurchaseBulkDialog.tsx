...
const QualityPurchaseBulkDialog: React.FC<AddNewPurchaseBulkDialogProps> = ({
    open,
    onClose,
    refreshData,
}) => {
    ...
    const handleDownloadSample = () => {
        const csvContent =
            `vendorName,billNumber,type,kantan,kg,paperType,height,width,length,for,forCompany
        \nraj,2000,kantan,mridu,10,,,,,Godown Manager,godown manager
        \nraj,2001,paper,,,sample paper,200,100,150,godown manager,godown manager
        \nraj,2001,glue,,10,,,,,godown manager,godown manager
        \nraj,2001,wire,,10,,,,,godown manager,godown manager`;
...
export default QualityPurchaseBulkDialog;