    ...
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        <Box pt={1}>
          <ThemeInput
            ...
            sx={{ mb: 2 }}
          />
          {/* File Upload for Invoice Proof - Commented as per new requirement */}
          {/* 
          <Box mb={2}>
      ...
      <DialogActions>
        ...
        <Button onClick={handleSubmit} variant="contained" disabled={loading}>
          {loading ? "Processing..." : "Submit Invoice Proof"}
        </Button>
      </DialogActions>
    </Dialog>
  )
...
export default InvoiceValidProofDialog
