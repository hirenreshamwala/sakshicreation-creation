...
//   const { staffId: si, startDate: st, endDate: e, status: s, reason: r, c, companyName: routerCompanyName } = router.query;
...
//       }));
//     }
//   }, [searchQuery, filters, si, st, e, r, selectedCompanyId, selectedStatus, canViewOwn, canViewGlobal, currentUserName]);
...
//     }
//   }, [searchQuery, filters, si, st, e, r, selectedCompanyId, selectedStatus, fetchLeadsForDate, canViewOwn, canViewGlobal, currentUserName]);
...
//       fetchDates();
//     }
//   }, [comapanyTab, tab, fetchDates, canViewGlobal, canViewOwn, router.isReady]);
...
//     // Remove the old canViewOwn API call since we're now handling it in the main fetch
